...
# [Built Portfolio With GitHub ](https://github.com/gautamgondaliya/gautam-portfolio.git)
...
```bash
git clone https://github.com/<YOUR GITHUB USERNAME>/gautam-portfolio.git
...
### Then, Customize data in the `utils/data` [folder](https://github.com/gautamgondaliya/gautam-portfolio/tree/main/utils/data).
...
export const personalData = {
  ...
  description: "My name is Gautam Gondaliya....",
  email: "gondaliyagautam311@gmail.com",
  phone: "+919723150397",
  address: "Ahmedabad,Gujarat",
  github: "https://github.com/gautamgondaliya/",
